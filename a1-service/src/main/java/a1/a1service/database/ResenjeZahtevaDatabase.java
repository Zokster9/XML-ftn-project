...
public class ResenjeZahtevaDatabase {
    ...
    public ResenjeZahteva dobaviPoBrojuAutorskog(String brojAutorskog) throws IOException, ClassNotFoundException, XMLDBException, InstantiationException, IllegalAccessException {
        AuthenticationUtilities.ConnectionProperties conn = AuthenticationUtilities.loadProperties();

        // initialize collection and document identifiers
        String collectionId = null;
        collectionId = "/db/xml-project/resenje-zahteva-autorska";
        ...
        try {
            ...
            String xPathExp = "//resenje_zahteva[referenca='" + brojAutorskog + "']";
