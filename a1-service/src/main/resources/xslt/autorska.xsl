        ...
        <html>
            ...
            <div class="docx-wrapper">
                <section class="docx" style="padding: 56.7pt; width: 595.35pt; min-height: 842pt;">
                    <article>
                        <p style="border-width: initial; border-style: none; border-color: initial; background-color: inherit; margin: 0pt; line-height: 1.15; text-indent: 0pt; text-align: left;"><span></span></p>
                        <table class="docx_table1" style="width: 492.75pt; table-layout: auto; margin-left: auto; margin-right: auto;">
                            ...
                            <tr>
                                <td style="vertical-align: top; border-width: 0.5pt; border-style: solid; border-color: rgb(0, 0, 0);">
                                    <p><span style="font-family: Calibri; font-weight: bold; min-height: 12pt; font-size: 12pt;">ЗАВОД ЗА ИНТЕЛЕКТУАЛНУ СВОЈИНУ                                             ОБРАЗАЦ А-1    </span><span></span></p>
                                    <p><span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">Београд, Кнегиње Љубице 5</span><span></span></p>
                                    <p><span></span></p>
                                    <p><span></span></p>
                                ...
                                <td style="vertical-align: top; border-width: 0.5pt; border-style: solid; border-color: rgb(0, 0, 0);">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="//podnosilac/ime">
                                            <p><span><xsl:value-of select="//podnosilac/ime"/>&#160;<xsl:value-of select="//podnosilac/prezime"/></span></p>
                                            <p><span><xsl:value-of select="//podnosilac/drzavljanstvo"/></span></p>
                                            <p><span></span></p>
                                            <p><span><xsl:value-of select="//podnosilac/adresa_lica/ulica"/>&#160;<xsl:value-of select="//podnosilac/adresa_lica/broj"/>, <xsl:value-of select="//podnosilac/adresa_lica/postanski_broj"/>&#160;<xsl:value-of select="//podnosilac/adresa_lica/grad"/>, <xsl:value-of select="//podnosilac/adresa_lica/drzava"/></span></p>
                                            <p><span></span></p>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <p><span></span></p>
                                            <p><span><xsl:value-of select="//podnosilac/poslovno_ime"/></span></p>
                                            <p><span><xsl:value-of select="//podnosilac/sediste/ulica"/>&#160;<xsl:value-of select="//podnosilac/sediste/broj"/>, <xsl:value-of select="//podnosilac/sediste/postanski_broj"/>&#160;<xsl:value-of select="//podnosilac/sediste/grad"/>, <xsl:value-of select="//podnosilac/sediste/drzava"/></span></p>
                                            <p><span></span></p>
                                            <p><span></span></p>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                    <table class="docx_table2" style="width: 490.5pt; text-align: left; table-layout: auto;">
                                        ...
                                        <tr style="height: 15.75pt;">
                                            <td style="vertical-align: top; border-width: 0.5pt; border-style: solid; border-color: rgb(0, 0, 0);">
                                                <p><span style="font-family: Arial;">телефон:<span class="docx-tab-stop"> </span></span><span><xsl:value-of select="//podnosilac/telefon"/></span></p>
                                            </td>
                                            <td style="vertical-align: top; border-width: 0.5pt; border-style: solid; border-color: rgb(0, 0, 0);">
                                                <p><span style="font-family: Arial;">e-mail:</span><span><xsl:value-of select="//podnosilac/email"/></span></p>
                                            </td>
                                        </tr>
                                    </table>
                                    <p><span></span></p>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="//punomocnik">
                                            <p><span><xsl:value-of select="//punomocnik/ime"/>&#160;<xsl:value-of select="//punomocnik/prezime"/></span></p>
                                            <p><span></span></p>
                                            <p><span></span></p>
                                            <p><span><xsl:value-of select="//punomocnik/adresa/ulica"/>&#160;<xsl:value-of select="//punomocnik/adresa/broj"/>, <xsl:value-of select="//punomocnik/adresa/postanski_broj"/>&#160;<xsl:value-of select="//punomocnik/adresa/grad"/>, <xsl:value-of select="//punomocnik/adresa/drzava"/></span></p>
                                            <p><span></span></p>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <p><span></span></p>
                                    ...
                                    <p><span>Naslov: <xsl:value-of select="//podaci_o_autorskom_delu/naslov"/></span></p>
                                    <p><span></span></p>
                                    <p><span>Alternativni naslov: <xsl:value-of select="//podaci_o_autorskom_delu/alternativni_naslov"/></span></p>
                                    <p><span></span></p>
                                    <p>
                                    ...
                                    <p><span></span></p>
                                    <p><span><xsl:value-of select="//podaci_o_autorskom_delu/naslov_autorskog_dela_prerade"/></span></p>
                                    <p><span></span></p>
                                    <p><span></span></p>
                                    <p>
                                    ...
                                    <p><span></span></p>
                                    <p><span><xsl:value-of select="//podaci_o_autorskom_delu/vrsta"/></span></p>
                                    <p><span></span></p>
                                    <p><span></span></p>
                                    <p>
                                    ...
                                    <p><span></span></p>
                                    <p><span><xsl:value-of select="//podaci_o_autorskom_delu/forma_zapisa"/></span></p>
                                    <p><span></span></p>
                                    <p>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="//podaci_o_autorskom_delu/anonimni_autor = 'true'">
                                            <p><span></span></p>
                                            <p><span></span></p>
                                            <p><span>Autorsko delo je delo anonimnog autora</span></p>
                                            <p><span></span></p>
                                            <p><span></span></p>
                                        </xsl:when>
                                        <xsl:when test="//podnosilac_autor = 'false'">
                                            <p><span></span></p>
                                            <xsl:for-each select="//podaci_o_autorskom_delu/autori">
                                                <xsl:choose>
                                                    <xsl:when test="godina_smrti">
                                                        <p><span>Autor:<xsl:value-of select="ime"/>&#160;<xsl:value-of select="prezime"/>, godina smrti:&#160;<xsl:value-of select="godina_smrti"/></span></p>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <p><span>Autor:<xsl:value-of select="ime"/>&#160;<xsl:value-of select="prezime"/>, <xsl:value-of select="drzavljanstvo"/>, <xsl:value-of select="adresa/ulica"/>&#160;<xsl:value-of select="adresa/broj"/>, <xsl:value-of select="adresa/postanski_broj"/>&#160;<xsl:value-of select="adresa/grad"/>, <xsl:value-of select="adresa/drzava"/></span></p>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:for-each>
                                            <p><span></span></p>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="//podaci_o_autorskom_delu/stvoreno_u_radnom_odnosu = 'true'">
                                            <p><span></span></p>
                                            <p><span>Autorsko delo je stvoreno u radnom odnosu</span></p>
                                            <p><span></span></p>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <p><span></span></p>
                                            <p><span>Autorsko delo nije stvoreno u radnom odnosu</span></p>
                                            <p><span></span></p>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                    <p>
                                    ...
                                    <p><span></span></p>
                                    <p><span></span></p>
                                    <p><span><xsl:value-of select="//podaci_o_autorskom_delu/nacin_koriscenja"/></span></p>
                                    <p><span></span></p>
                                    <p><span></span></p>
                                    <p>
                                        <span style="font-family: Calibri; font-weight: bold; min-height: 12pt; font-size: 12pt;">____________________________________________</span>
                                        <span></span>
                                    </p>
                                    <p class="docx-num-1-0" style="text-indent: -192.75pt; margin-left: 191.3pt;">
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">            </span>
                                        <span style="font-family: Calibri; font-weight: bold; min-height: 12pt; font-size: 12pt;">Подносилац пријаве, носилац права</span>
                                        <span></span>
                                    </p>
                                    <p style="text-indent: -1.45pt;">
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">                                                                    (место за потпис физичког лица, односно потпис</span>
                                    </p>
                                    <p style="text-indent: -1.45pt;">
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">                                                                     заступника правног лица или овлашћеног представника</span>
                                    </p>
                                    <p style="text-indent: -1.45pt;">
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">                                                                      у правном лицу)*                                                                       </span>
                                    </p>
                                    <p>
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">                                                                                                                                                      </span>
                                        <span></span>
                        ...
                        <table class="docx_table3" style="width: 492.75pt; text-align: left; table-layout: auto;">
                            ...
                            <tr style="height: 370.3pt;">
                                <td colspan="3" style="border-top: 0.5pt solid rgb(0, 0, 0); border-left: 0.5pt solid rgb(0, 0, 0); border-bottom: none; border-right: 0.5pt solid rgb(0, 0, 0); vertical-align: top;">
                                    <p>
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">12) Прилози који се подносе уз захтев:</span>
                                    </p>
                                    <p><span></span></p>
                                    <p style="text-indent: -1.45pt;">
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">                                                            </span>
                                    ...
                                    <p style="text-align: center;">
                                        <span style="font-family: Calibri; font-weight: bold; min-height: 12pt; font-size: 12pt;">ПОПУЊАВА ЗАВОД:</span>
                                        <span></span>
                                    </p>
                                    <p style="text-align: justify;"><span></span>
                                    </p>
                                    <p>
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;"><span class="docx-tab-stop"> </span></span>
                                        <span style="font-family: Calibri; font-weight: bold; min-height: 12pt; font-size: 12pt;">Прилози уз пријаву:</span>
                                        <span></span>
                                    </p>
                                    <p><span></span></p>
                                    <p>
                                        <span style="font-family: Czar; min-height: 12pt; font-size: 12pt;"></span>
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;"> опис ауторског дела (ако је дело поднето на оптичком диску);</span>
                                    </p>
                                    <p><span></span></p>
                                    <p>
                                        <span style="font-family: Czar; min-height: 12pt; font-size: 12pt;"></span>
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;"> п</span>
                                        <span style="font-family: Calibri; min-height: 12pt; font-size: 12pt;">ример ауторског дела (слика, видео запис, аудио запис)</span>
                                        <span></span>
                                    </p>
                                </td>
                            </tr>
                            <tr style="height: 49.8pt;">
                                <td rowspan="2" style="border-top: none; border-left: 0.5pt solid rgb(0, 0, 0); border-right: 0.5pt solid rgb(0, 0, 0); vertical-align: top; border-bottom: 0.5pt solid rgb(0, 0, 0);">
                                    <p><span></span></p>
                                </td>
                                <td style="border-width: 0.5pt; border-style: solid; border-color: rgb(0, 0, 0); vertical-align: top;">
                                    ...
                                    <p><span></span></p>
                                    <p>
                                        <span style="font-family: Arial; font-weight: bold; min-height: 18pt; font-size: 18pt;"> <xsl:value-of select="//broj_prijave"/></span>
                                        <span></span>
                                    </p>
                                </td>
                            ...
                            <tr style="height: 29.25pt;">
                                ...
                                <td style="border-width: 0.5pt; border-style: solid; border-color: rgb(0, 0, 0); vertical-align: top;">
                                    ...
                                    <p><span><xsl:value-of select="//datum_prijave"/></span></p>
                                    <p><span></span></p>
                                    <p><span></span></p>
                                </td>
