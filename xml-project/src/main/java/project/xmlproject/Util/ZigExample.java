...
//        unmarshaller.setSchema(schema);
    ...
    private void printPriloziUzZahtev(ZahtevZaPriznanjeZiga.PodaciOPrijavi.PriloziUzZahtev priloziUzZahtev) {
        ...
        printSpisakRobeIUsluga(priloziUzZahtev.getSpisakRobeIUsluga());
    ...
    private void printSpisakRobeIUsluga(ZahtevZaPriznanjeZiga.PodaciOPrijavi.PriloziUzZahtev.SpisakRobeIUsluga spisakRobeIUsluga) {
        System.out.println("\t\t\t\t\tSpisak robe i usluga:");
        System.out.println("\t\t\t\t\t\t{");
        spisakRobeIUsluga.getSpisak().forEach(this::printSpisak);
        System.out.println("\t\t\t\t\t\t},");
    }

    private void printSpisak(ZahtevZaPriznanjeZiga.PodaciOPrijavi.PriloziUzZahtev.SpisakRobeIUsluga.Spisak spisak) {
        System.out.println("\t\t\t\t\t\t\tSpisak:");
        System.out.println("\t\t\t\t\t\t\t\t{");
        System.out.println("\t\t\t\t\t\t\t\t\tKlasa: " + spisak.getKlasa());
        printUsluge(spisak.getUsluge());
        System.out.println("\t\t\t\t\t\t\t\t},");
    }

    private void printUsluge(ZahtevZaPriznanjeZiga.PodaciOPrijavi.PriloziUzZahtev.SpisakRobeIUsluga.Spisak.Usluge usluge) {
        System.out.println("\t\t\t\t\t\t\t\t\tUsluge: ");
        usluge.getNaziv().forEach(this::printUsluga);
    }
