package app.userservice.database;

import app.userservice.model.Korisnik;
import app.userservice.util.AuthenticationUtilities;
...
public class ReadUnmarshal {
    ...
    public Korisnik dobaviPoKorisnickomImenu(String korisnickoIme) throws IOException, ClassNotFoundException, XMLDBException, InstantiationException, IllegalAccessException {
        AuthenticationUtilities.ConnectionProperties conn = AuthenticationUtilities.loadProperties();

        // initialize collection and document identifiers
        String collectionId = null;
        collectionId = "/db/xml-project/korisnici";
        ...
        try {
            ...
            String xPathExp = "//*[korisnickoIme='" + korisnickoIme + "']";
